    ...
    <div className="px-4 flex-1 mt-6">
        ...
        <div className="flex flex-col gap-1">
            ...
            <button key={item.id} onClick={()=> setActiveView(item.id)}
                className={`flex items-center gap-3 px-3 py-3 rounded-sm text-sm transition-all duration-300 group ${
                activeView === item.id
                ...
                <div key={key}>
                    ...
                    <div className="flex items-center gap-3 group">
                        <div
                            ...
                            <input type="color" value={val} onChange={(e)=> setColors({...colors, [key]:
                            e.target.value})}
                ...
                <div className="w-full max-w-[380px] p-10 rounded-sm border border-white/20 shadow-[0_0_50px_rgba(0,0,0,0.8)] transition-colors duration-300 relative overflow-hidden backdrop-blur-xl"
                    ...
                    <div className="space-y-5">
                        ...
                        <button
                            ...
                            style={{backgroundColor: colors.accent, color: colors.primary==='#ffffff' ? '#000' :
...
<div className="flex h-screen w-screen overflow-hidden text-sm font-sans">
    ...
    <main className="flex-1 bg-transparent relative z-10 overflow-hidden flex flex-col">
        ...
        <div className="h-full flex items-center justify-center flex-col animate-in">
            <div
                className="w-20 h-20 border border-white/10 rounded-sm flex items-center justify-center mb-8 bg-black/20">
            ...
            <p className="text-text-muted font-mono text-xs uppercase tracking-widest">Awaiting Phase 5 Implementation
            </p>
        </div>
        )}
    </main>
